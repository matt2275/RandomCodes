...
float* isGoodEvent(vector <int> PID, vector<float> Muon[3], vector<float> Ele[3], vector<float> Trk[3]){
...
void Check_Leptons(string inputfile, string outfile)
{
